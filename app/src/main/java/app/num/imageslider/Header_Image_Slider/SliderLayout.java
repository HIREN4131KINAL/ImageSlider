package app.num.imageslider.Header_Image_Slider;
...
import app.num.imageslider.Header_Image_Slider.Animations.BaseAnimationInterface;
import app.num.imageslider.Header_Image_Slider.Animations.DescriptionAnimation;
import app.num.imageslider.Header_Image_Slider.Indicators.PagerIndicator;
import app.num.imageslider.Header_Image_Slider.SliderTypes.BaseSliderView;
import app.num.imageslider.Header_Image_Slider.Transformers.AccordionTransformer;
import app.num.imageslider.Header_Image_Slider.Transformers.BaseTransformer;
import app.num.imageslider.Header_Image_Slider.Tricks.FixedSpeedScroller;
import app.num.imageslider.Header_Image_Slider.Tricks.InfinitePagerAdapter;
import app.num.imageslider.Header_Image_Slider.Tricks.InfiniteViewPager;
import app.num.imageslider.Header_Image_Slider.Tricks.ViewPagerEx;
import app.num.imageslider.R;
